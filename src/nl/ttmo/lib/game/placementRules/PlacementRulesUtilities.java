...
import nl.ttmo.lib.game.world.MapGridSquare;
...
public class PlacementRulesUtilities
{
	 ...
	 */
	protected static boolean checkIfOnTopOf(Location baseLocation, String type)
	{
	 ...
	 */
	protected static boolean checkIfNextTo(Location baseLocation, String type)
	{
	 ...
	 */
	protected static boolean checkIfNear(Location baseLocation, String type, int radius)
	{
	 ...
	 */
	protected static boolean checkIfThroughReachable(Location baseLocation, String type, String typeThrough)
	{
	 ...
	 */
	protected static boolean checkIfThroughNear(Location baseLocation, String type, String typeThrough, int distance)
	{
